...
do
  ...
  -a ${arch} -b ${bs} --tpt --ctx_init ${ctx_init}  --memory_size 50 --text_prompt tip_cupl  --log cvpr_final_dmn_tf_resnet_searched_channel_3_32 \
...
data_root='/data3/tuning/'
testsets=I/Flower102/DTD/Pets/Cars/UCF101/Caltech101/Food101/SUN397/Aircraft/eurosat
num_important_channel=500/800/0
lambda_ape=0.3/0.7
lr=0.0001
epoch=20
arch=RN50
